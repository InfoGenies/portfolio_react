...
const Navbar = () => {
    ...
    const handleScroll = () => document.getElementById('contact').scrollIntoView();
        ...
        <div className="container flex items-center relative justify-between flex-wrap">
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse">
                   <stop stopColor="#E1522D" />
                <stop offset="1" stopColor="#f37b5e" />
                </linearGradient>
              </defs>
            </motion.svg>
          </a>
          ...
          <div className="hidden items-center gap-8 md:flex">
            <motion.button
              ...
              className="border-2 border-orange-800 py-[2px] rounded px-[25px] text-[1.2rem] relative z-10 before:absolute before:top-0 before:left-0 before:w-0 before:h-full before:bg-bgGradient hover:before:w-full before:z-[-1] before:transition-all hover:scale-[1.1] hover:border-none before:rounded hover:text-white transition-all duration-500 before:duration-500 ">
              Contact
            </motion.button>
            <motion.div
              initial={{
